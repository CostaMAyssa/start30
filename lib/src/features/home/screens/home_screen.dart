...
class HomeScreen extends StatelessWidget {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Adiciona o prompt de documentação estratégica
                      _buildPromptItem(isMobile: isMobile),
                    ],
                  ),
                ),
              ),
  ...
  // Widget para item de FAQ com prompt específico
            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Prompt para Documentação Estratégica',
                      style: GoogleFonts.poppins(
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Crie uma documentação estratégica para o meu negócio, estruturada com os seguintes elementos:',
                      style: GoogleFonts.poppins(
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                        color: Colors.white,
                    ...
                    const SizedBox(height: 16),
                    _buildPromptTopicItem(
                      title: 'Propósito e Missão',
                      description: 'Descreva a razão de existência do negócio e o impacto que ele busca gerar.',
                    ),
                    _buildPromptTopicItem(
                      title: 'Visão de Futuro',
                      description: 'Defina onde o negócio pretende estar em médio e longo prazo.',
                    ),
                    _buildPromptTopicItem(
                      title: 'Valores e Cultura',
                      description: 'Liste os princípios que orientam as decisões e a identidade do negócio.',
                    ),
                    _buildPromptTopicItem(
                      title: 'Posicionamento e Diferencial',
                      description: 'Explique o que torna o negócio único e competitivo.',
                    ),
                    _buildPromptTopicItem(
                      title: 'Objetivos Estratégicos',
                      description: 'Estabeleça metas claras para o crescimento e consolidação do negócio.',
                    ),
                    _buildPromptTopicItem(
                      title: 'Plano de Ação',
                      description: 'Proponha estratégias e táticas para atingir os objetivos definidos.',
                    ),
                    const SizedBox(height: 16),
                    Text(
                      'A documentação deve ser clara, objetiva e adaptada à realidade do meu negócio. Utilize um tom profissional, mas acessível. Se necessário, inclua exemplos ou sugestões práticas.',
                      style: GoogleFonts.poppins(
                        fontSize: 15,
                        fontStyle: FontStyle.italic,
                        color: Colors.white.withOpacity(0.8),
              ...
              SizedBox(
                ...
                child: Builder(
                  builder: (context) => ElevatedButton.icon(
                    onPressed: () {
                      // Copiar texto do prompt para a área de transferência
                      final promptText = 'Crie uma documentação estratégica para o meu negócio, estruturada com os seguintes elementos:\n\n'
                          'Propósito e Missão – Descreva a razão de existência do negócio e o impacto que ele busca gerar.\n'
                          'Visão de Futuro – Defina onde o negócio pretende estar em médio e longo prazo.\n'
                          'Valores e Cultura – Liste os princípios que orientam as decisões e a identidade do negócio.\n'
                          'Posicionamento e Diferencial – Explique o que torna o negócio único e competitivo.\n'
                          'Objetivos Estratégicos – Estabeleça metas claras para o crescimento e consolidação do negócio.\n'
                          'Plano de Ação – Proponha estratégias e táticas para atingir os objetivos definidos.\n\n'
                          'A documentação deve ser clara, objetiva e adaptada à realidade do meu negócio. Utilize um tom profissional, mas acessível. Se necessário, inclua exemplos ou sugestões práticas.';
  ...
  // Widget para tópicos do prompt
  Widget _buildPromptTopicItem({
    required String title,
    required String description,
  }) {
    return Padding(
  ...
  // Widget para botão com estilo Stripe
  Widget StripeButton({
    ...
    return Container(
      ...
      child: ElevatedButton(
        onPressed: onPressed,
        style: ElevatedButton.styleFrom(
          backgroundColor: isSecondary || isOutlined
              ? Colors.transparent
              : Colors.white.withOpacity(0.1),
          foregroundColor: Colors.white.withOpacity(0.95),
          elevation: 0,
